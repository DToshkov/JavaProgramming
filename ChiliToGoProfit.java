...
final double CHILD_COST = 3.1 ; 

adultProfit = totalAdult - (ADULT_COST * adultMeals);
childProfit = totalChild - (CHILD_COST * childMeals);
profitTotal = childProfit + adultProfit;
System.out.println("    Adult profit is " + adultProfit);
System.out.println("    Child profit is " + childProfit);
System.out.println("Total profit is " + profitTotal);
